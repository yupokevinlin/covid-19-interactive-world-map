    ...
    appState.isInitComplete ? (
      <ThemeProvider theme={appState.theme}>
        <Router history={history}>
          {
            <Navigation width={width} pageTitle={pageTitle} menuItems={appState.menuItems} version={appState.version} isLoading={appState.isLoading} themeColor={appState.themeColor} handleMenuItemClick={handleMenuItemClick} handleMenuItemChildClick={handleMenuItemChildClick}>
